...
def run_image_1():
    print("This image is the image used in the article.\nThe parameters of p_tild are: mode=0, alpha=150, omega=0.01")
    print("The computation time is approximately 10s")
    # Initialisation
    start_x = 26
    start_y = 65
    end_x = 355
    ...
    P_tilde = func.p_tild(image_pretreated, mode=0, alpha=150, sigma=0.01, omega=0.01)
    t3 = time.time()
